...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.parminima_2 = QLabel(Widget)
        self.parminima_2.setObjectName(u"parminima_2")
        self.parminima_2.setGeometry(QRect(80, 160, 49, 16))
        self.parminima_3 = QLabel(Widget)
        self.parminima_3.setObjectName(u"parminima_3")
        self.parminima_3.setGeometry(QRect(80, 190, 49, 16))
        self.parminima_4 = QLabel(Widget)
        self.parminima_4.setObjectName(u"parminima_4")
        self.parminima_4.setGeometry(QRect(60, 220, 70, 16))
        self.parminima_5 = QLabel(Widget)
        self.parminima_5.setObjectName(u"parminima_5")
        self.parminima_5.setGeometry(QRect(64, 240, 70, 16))
    ...
    def retranslateUi(self, Widget):
        ...
        self.parminima_2.setText(QCoreApplication.translate("Widget", u"minima", None))
        self.parminima_3.setText(QCoreApplication.translate("Widget", u"maxima", None))
        self.parminima_4.setText(QCoreApplication.translate("Widget", u"Compressor", None))
        self.parminima_5.setText(QCoreApplication.translate("Widget", u"Temp Atual", None))
    # retranslateUi
